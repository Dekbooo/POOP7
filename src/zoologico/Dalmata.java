...
public class Dalmata extends Perro { 
    ...
    public Dalmata(String nombre, int edad, String especie, float peso, String habitat, String raza, String colorPelaje, int numeroManchas) { 
        ...
        // Llama al constructor de la superclase (Perro), pasando los atributos específicos de la clase Perro 

        super(nombre, edad, especie, peso, habitat, raza, colorPelaje, false, 80, true); 
